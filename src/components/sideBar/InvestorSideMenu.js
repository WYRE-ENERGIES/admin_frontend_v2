  ...
  const MenuContent = () => (
    <div className="investor-sider-inner">
      <div className="investor-sider-top">
        <div className={`investor-sider-brand${collapsed && !isMobile ? " investor-sider-brand--collapsed" : ""}`}>
          <div className="investor-sider-brand-logo">
            <Image width={collapsed && !isMobile ? 32 : 70} preview={false} src="/Images/Wyre white-08 1.png" />
            {!collapsed && (
          ...
          {!isMobile && (
            <Button
              ...
              className="investor-sider-toggle"
            />
          )}
        </div>
        <Menu
